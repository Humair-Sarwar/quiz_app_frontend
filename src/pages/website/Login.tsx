...
import { HiOutlineLightBulb, HiOutlineMail, HiOutlineLockClosed } from "react-icons/hi";
...
const Login: React.FC = () => {
        ...
        <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <AnimatePresence>
                {errors.email && (
                  <motion.p initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="text-red-500 text-[11px] font-bold ml-1">{errors.email}</motion.p>
                )}
              </AnimatePresence>
            </div>
  ...
  >
    Forgot?
              ...
              <div className="relative group">
                <HiOutlineLockClosed className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#ff5b07] transition-colors" size={20} />
                <input
              ...
              <AnimatePresence>
                {errors.password && (
                  <motion.p initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="text-red-500 text-[11px] font-bold ml-1">{errors.password}</motion.p>
                )}
              </AnimatePresence>
            </div>
            ...
            <motion.button
              ...
              className="w-full bg-slate-900 text-white cursor-pointer py-4 rounded-2xl font-black uppercase tracking-[0.2em] text-[11px] hover:bg-[#ff5b07] transition-all shadow-xl shadow-slate-200 hover:shadow-orange-200 flex justify-center items-center"
            >
          ...
          <div className="mt-10 text-center">
            <p className="text-slate-500 text-sm font-medium">
              ...
              <NavLink to="/join-now" className="text-slate-900 font-bold hover:text-[#ff5b07] transition-colors">
                Create One Free
              </NavLink>
            </p>
          </div>
